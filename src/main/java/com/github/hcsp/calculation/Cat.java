...
public class Cat {
    ...
    public void setCute(boolean cute) {
        if(cute) properties = CUTE|properties;
    }
    ...
    public void setFat(boolean fat) {
        if(fat) properties = FAT|properties;
    }
    ...
    public void setWhite(boolean white) {
        if(white) properties = WHITE|properties;
    }
